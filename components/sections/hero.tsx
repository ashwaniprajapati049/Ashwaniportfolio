    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-6 z-10 max-w-4xl">
        <div className="flex flex-col items-center text-center">
          ...
          >
            Building modern web experiences with scalable architecture, clean
           and performance-driven engineering at{" "}
          ...
          >
            <Link href="/#projects">
              <Button
                size="lg"
                className="group bg-green-600 hover:bg-green-700 text-white rounded-full px-6"
              >
                View Projects
